...
function loadPopup(){
  ...
  let popup = `<div class="popup-owpm"> 
    <div class="popup" id="popup-owpm-id">
      ...
      <p style="margin:10px; padding-left:10px; font-size:18px;">We found <span style="background-color: ${cookieColor}; border-radius: 15%; padding-left: 1px; ; padding-right: 1px;">${numCookies} cookies</span> on this page</p>
      <p style="margin:10px; padding-left:10px; font-size:16px;"><span style="background-color: ${httpColor}; border-radius: 15%; padding-left: 1px; padding-right: 1px;">${numNotHTTP}/${numCookies}</span> are visible to outside scripts</p>
      <p style="margin:10px; padding-left:10px; font-size:16px;"><span style="background-color: ${hostColor}; border-radius: 15%; padding-left: 1px; padding-right: 1px;">${numNotHost}/${numCookies}</span> are sent to multiple subdomains</p>
